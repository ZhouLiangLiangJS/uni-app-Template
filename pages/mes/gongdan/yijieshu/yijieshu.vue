<template>
	<view>
		<view class="hader-box">
					 ...
					 <text class="hader-box-text">已结束</text>
		</view>
		...
		<view class="main-box" v-for="(item,i) in listArr" :key="i" v-if="item.workover!=0?item.num>=item.people?item.settlement!=0?true:false:false:false">
				<view class="main-box-title">
					<!-- <span></span> -->
					<text class="gray">已付款</text>
					<!-- <text>2天</text> -->
					<text style="float: right; margin-right:30upx ; color: #FE6C0E;">付款成功</text>
				</view>
				...
				<view class="main-box-bot">
					...
					<view style="margin-top: 30upx;">
						...
						<view style="color:#b1b1b1;width: 124upx;font-weight: 500;background: #fff;" class="btn-style">已付款</view>
