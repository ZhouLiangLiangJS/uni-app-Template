<template>
	<view>
		<view class="hader-box">
					 ...
					 <text class="hader-box-text">已完成</text>
		</view>
		
		<view class="main-box" @click="showgn" v-for="(item,i) in listArr" :key="i" v-if="item.rnum>=item.num?item.workover!=0?item.workstate==0?item.settlement==0?true:false:false:false:false">
